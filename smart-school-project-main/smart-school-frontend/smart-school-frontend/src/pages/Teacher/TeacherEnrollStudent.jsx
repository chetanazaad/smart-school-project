...
export default function TeacherEnrollStudent() {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-semibold mb-5">Teacher - Enroll Student</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
        ...
        <div className="bg-blue-50 p-4 rounded border border-blue-200">
          ...
          <input
            ...
            required
          />
          <p className="text-sm text-gray-600 mt-2">Password must be 8+ chars with uppercase, lowercase, digit, and symbol</p>
        </div>

        <div>
          <label className="block text-sm font-medium mb-2">Enroll Face (3 angles required for maximum accuracy)</label>
